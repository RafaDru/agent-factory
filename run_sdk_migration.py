    ...
    async with sse_client('http://127.0.0.1:9091/sse') as streams:
        async with ClientSession(*streams) as session:
            ...
            result = await session.call_tool('run_objective', {
                ...
                'objective': 'Refatorar agentes para usar o novo SDK StandardBaseAgent.',
                'context': 'O time deve migrar todos os agentes do projeto para o novo SDK e rodar testes de integridade.'
            })
