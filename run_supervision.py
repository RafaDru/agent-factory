    ...
    async with sse_client('http://127.0.0.1:9091/sse') as streams:
        async with ClientSession(*streams) as session:
            ...
            result = await session.call_tool('run_objective', {
                ...
                'objective': 'Padronizar eventos com metrica de modelo LLM e revisar layout do dashboard.',
                'context': 'Workers devem injetar {"model": ...} em seus eventos. Design deve revisar UX/UI.'
            })
