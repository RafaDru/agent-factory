...
| planejamento | Estrategias de planejamento, DAG, dependencias | tree/planejamento.md |
| delegacao | Padroes de delegacao, alocacao de agentes | tree/delegacao.md |
| priorizacao | Criterios de priorizacao, backlog, epicos/historias | tree/priorizacao.md |